...
import com.githubdemo.`in`.data.util.Constant.RESPONSE_NO_INTERNET
import com.githubdemo.`in`.data.util.Constant.RESPONSE_LOADING
import com.githubdemo.`in`.data.util.Constant.RESPONSE_SUCESS
...
import com.githubdemo.`in`.presentation.adapter.GitHubRepoListAdapter
